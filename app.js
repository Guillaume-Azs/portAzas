...
typewriter
  ...
  .typeString("Je suis... ")
  .pauseFor(300)
  .typeString("<strong> Intégrateur HTML</strong> !")
  .pauseFor(1000)
  .deleteChars(6)
  .typeString('<span style="color: #27ae60;"> CSS</span> !')
  .pauseFor(1000)
  .deleteChars(6)
  .typeString('<span style="color: #EA39ff;"> Photoshop</span> !')
  .pauseFor(1000)
  .deleteChars(25)
  .typeString(
    '<strong> Référent</stong><span style="color: #A34531;"> SEO</span> !'
  )
  .pauseFor(1000)
  .deleteChars(14)
  .typeString(
    '<span style="color: midnightblue;"> Adepte des réseaux sociaux</span> !'
  )
  .pauseFor(1000)
  .deleteChars(28)
  .typeString('<span style="color: #ff6910;"> Passionné par le web</span> !')
  .start();
